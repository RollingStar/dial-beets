...
class CopyArtifactsPlugin(BeetsPlugin):
    def __init__(self):
        ...
        self.path_formats = [c for c in beets.ui.get_path_formats() if c[0][:4] == 'ext:']
    ...
    def _format(self, value):
        ...
        '''
        sep_repl = beets.config['path_sep_replace'].get(str)
    ...
    def add_artifacts(self, task, session):
        ...
        mapping = {
            ...
            'albumartist': imported_item.albumartist or 'None',
